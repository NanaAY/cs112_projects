/* List.h
 * Student Name:Nana Osei Asiedu Yirenkyi(na29) and Hansel Langford
 * Date: Oct 14 2018
 * PROJECT05
 *
 * operator!=(), writeTo(ostream), readFrom(string), getIndexOf() and remove(Index) methods written by Nana Osei (na29)
 */
